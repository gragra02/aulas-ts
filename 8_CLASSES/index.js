...
const graziele = new User();
graziele.name = "Graziele";
console.log(graziele);
// 2 - constructor
class NewUser {
...
const grazieleda Silva = new Person("Graziele", "da Silva");
console.log(grazieleda Silva.fullName);
// 8 - setter
class Coords {
    set fillX(x) {
        if (x === 0) {
